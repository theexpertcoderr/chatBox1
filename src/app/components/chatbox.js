...
export default function ChatBox() {
    ...
    const [isCloseKeyboard, setKeyboardClose] = useState(true);
    const [keyboardHeight, setKeyboardHeight] = useState(0);


    const smoothKeyboardCloseClass = {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setKeyboardClose(!isKeyboardOpen);
        };
    ...
    return (
             <div className='justify-center flex items-center flex-col'>
                 <div id="Chat-Containar" className={isCloseKeyboard ? 'rounded-lg border-2 border-[#248991] shadow-md sm:w-72 w-[100%] md:w-[50%] lg:w-[50%] h-[93vh] lg:h-[600px] flex flex-col overflow-hidden' : 'rounded-lg border-2 border-[#248991] shadow-md sm:w-72 w-[100%] md:w-[50%] lg:w-[50%] h-[93vh] lg:h-[600px] flex flex-col overflow-hidden'}>
                     <div id='Header' className='justify-center flex items-center min-h-14 w-auto bg-[#248991] top-0 left-0 right-0'>
                     ...
                     <div id='Chat-history' ref={chatHistoryRef} className="bg-white flex-grow overflow-y-auto h-100em scrollbar-thin scrollbar-thumb-[#248991] scrollbar-track-[#E5E7EB] scrollbar-thumb-rounded-full scrollbar-track-rounded-full" style={{ overflowX: 'hidden' }}>
